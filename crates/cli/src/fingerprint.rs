...
/// Gather information about the current machine, a Wasm benchmark, or a Wasm engine and print the
/// results to `stdout`.
...
pub struct FingerprintCommand {
    ...
    /// The optional path to the file to fingerprint; not all kinds fingerprinting require a file
    /// (e.g., `--kind machine`).
